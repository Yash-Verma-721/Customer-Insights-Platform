...
def show_vendor_registration():
    ...
    with col2:
        ...
        with st.form("vendor_registration_form"):
            ...
            business_name = st.text_input("Company Name", placeholder="Enter your registered company name")
            owner_name = st.text_input("Vendor Name (Representative)", placeholder="e.g. Yash Verma")
